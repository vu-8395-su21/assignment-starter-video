...
public class VideoFileManager {
	...
	private Path getVideoPath(Video v){
		...
		// Can you spot the potential injection attack here?
	...
	public void copyVideoData(Video v, OutputStream out) throws IOException {
		...
		// Taking in client data like this and storing it on disk requires a
		// ton of care that isn't present here. Don't use this is an example
		// of what would be safe in a production application.
		Path source = getVideoPath(v);
